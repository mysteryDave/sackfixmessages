...
case class CollateralResponseMessage(collRespIDField:CollRespIDField,
                                     collAsgnIDField:CollAsgnIDField,
...
object CollateralResponseMessage extends SfFixMessageDecoder {
  ...
  override val MandatoryFields = HashSet[Int](
    CollRespIDField.TagId, CollAsgnIDField.TagId, CollAsgnReasonField.TagId, CollAsgnRespTypeField.TagId, TransactTimeField.TagId)
  ...
  override val OptionalFields = HashSet[Int](
    CollReqIDField.TagId, CollAsgnTransTypeField.TagId, CollAsgnRejectReasonField.TagId, AccountField.TagId, AccountTypeField.TagId, 
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(CollateralResponseMessage(CollRespIDField.decode(myFields.get(CollRespIDField.TagId)).get,
        CollAsgnIDField.decode(myFields.get(CollAsgnIDField.TagId)).get,
