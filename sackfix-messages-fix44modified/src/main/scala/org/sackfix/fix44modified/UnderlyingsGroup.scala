...
/**
  ...
  */
case class UnderlyingsGroup(underlyingInstrumentComponent:Option[UnderlyingInstrumentComponent]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
