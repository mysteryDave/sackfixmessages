...
object OrderStatusRequestMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    OrderIDField.TagId, SecondaryClOrdIDField.TagId, ClOrdLinkIDField.TagId, OrdStatusReqIDField.TagId, AccountField.TagId, 
    AcctIDSourceField.TagId, NoUnderlyingsField.TagId)
