...
object QuoteStatusReportMessage extends SfFixMessageDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    OrderQtyDataComponent.isMandatoryField(tagId) || StipulationsComponent.isMandatoryField(tagId) || LegsGroup.isMandatoryField(tagId) || QuoteQualifiersGroup.isMandatoryField(tagId) || 
    SpreadOrBenchmarkCurveDataComponent.isMandatoryField(tagId) || YieldDataComponent.isMandatoryField(tagId)
  }

  override val OptionalFields = HashSet[Int](
    QuoteStatusReqIDField.TagId, QuoteReqIDField.TagId, QuoteRespIDField.TagId, QuoteTypeField.TagId, TradingSessionIDField.TagId, 
    TradingSessionSubIDField.TagId, NoUnderlyingsField.TagId, SideField.TagId, SettlTypeField.TagId, SettlDateField.TagId, 
    SettlDate2Field.TagId, OrderQty2Field.TagId, CurrencyField.TagId, AccountField.TagId, AcctIDSourceField.TagId, 
    AccountTypeField.TagId, NoLegsField.TagId, NoQuoteQualifiersField.TagId, ExpireTimeField.TagId, PriceField.TagId, 
    PriceTypeField.TagId, BidPxField.TagId, OfferPxField.TagId, MktBidPxField.TagId, MktOfferPxField.TagId, 
    MinBidSizeField.TagId, BidSizeField.TagId, MinOfferSizeField.TagId, OfferSizeField.TagId, ValidUntilTimeField.TagId, 
    ...
    CommTypeField.TagId, CommissionField.TagId, CustOrderCapacityField.TagId, ExDestinationField.TagId, QuoteStatusField.TagId, 
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    OrderQtyDataComponent.isOptionalField(tagId) || StipulationsComponent.isOptionalField(tagId) || LegsGroup.isOptionalField(tagId) || QuoteQualifiersGroup.isOptionalField(tagId) || 
  ...
  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    ...
    UnderlyingsGroup.isFieldOf(tagId) || OrderQtyDataComponent.isFieldOf(tagId) || StipulationsComponent.isFieldOf(tagId) || 
    LegsGroup.isFieldOf(tagId) || QuoteQualifiersGroup.isFieldOf(tagId) || SpreadOrBenchmarkCurveDataComponent.isFieldOf(tagId) || 
    YieldDataComponent.isFieldOf(tagId)

   override lazy val RepeatingGroupsTags = HashSet[Int](
    NoUnderlyingsField.TagId, NoLegsField.TagId, NoQuoteQualifiersField.TagId)
