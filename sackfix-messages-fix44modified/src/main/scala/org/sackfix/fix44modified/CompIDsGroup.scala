...
case class CompIDsGroup(refCompIDField:Option[RefCompIDField]=None,
                        ...
                        statusValueField:Option[StatusValueField]=None,
  ...
  def format( fmt: ((StringBuilder,SfFixRenderable)=>Unit), b:StringBuilder = new StringBuilder()): StringBuilder = {
    ...
    statusValueField.foreach(fmt(b,_))
...
object CompIDsGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    RefCompIDField.TagId, RefSubIDField.TagId, LocationIDField.TagId, DeskIDField.TagId, StatusValueField.TagId, 
    StatusTextField.TagId)
    ...
    if (!isFirstField(flds(startPos)._1)) (startPos, None)
      ...
      if (myFields.nonEmpty) {
        (pos,Some(CompIDsGroup(myFields.get(RefCompIDField.TagId).flatMap(f=>RefCompIDField.decode(f)),
          ...
          myFields.get(StatusValueField.TagId).flatMap(f=>StatusValueField.decode(f)),
