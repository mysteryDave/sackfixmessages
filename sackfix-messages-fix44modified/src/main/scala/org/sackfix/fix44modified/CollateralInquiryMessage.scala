...
/**
  ...
  */
case class CollateralInquiryMessage(collInquiryIDField:Option[CollInquiryIDField]=None,
                                    ...
                                    encodedTextField:Option[EncodedTextField]=None) extends SfFixMessageBody("BB")  with SfFixRenderable with SfFixFieldsToAscii {
...
object CollateralInquiryMessage extends SfFixMessageDecoder {
  val MsgType="BB"
  val MsgName="CollateralInquiry"
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    TrdRegTimestampsComponent.isMandatoryField(tagId) || SpreadOrBenchmarkCurveDataComponent.isMandatoryField(tagId) || StipulationsComponent.isMandatoryField(tagId) || SettlInstructionsDataComponent.isMandatoryField(tagId)
  }

  override val OptionalFields = HashSet[Int](
    CollInquiryIDField.TagId, NoCollInquiryQualifierField.TagId, SubscriptionRequestTypeField.TagId, ResponseTransportTypeField.TagId, ResponseDestinationField.TagId, 
    AccountField.TagId, AccountTypeField.TagId, ClOrdIDField.TagId, OrderIDField.TagId, SecondaryOrderIDField.TagId, 
    SecondaryClOrdIDField.TagId, NoExecsField.TagId, NoTradesField.TagId, SettlDateField.TagId, QuantityField.TagId, 
    QtyTypeField.TagId, CurrencyField.TagId, NoLegsField.TagId, NoUnderlyingsField.TagId, MarginExcessField.TagId, 
    TotalNetValueField.TagId, CashOutstandingField.TagId, SideField.TagId, PriceField.TagId, PriceTypeField.TagId, 
    AccruedInterestAmtField.TagId, EndAccruedInterestAmtField.TagId, StartCashField.TagId, EndCashField.TagId, TradingSessionIDField.TagId, 
    TradingSessionSubIDField.TagId, SettlSessIDField.TagId, SettlSessSubIDField.TagId, ClearingBusinessDateField.TagId, TextField.TagId, 
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    TrdRegTimestampsComponent.isOptionalField(tagId) || SpreadOrBenchmarkCurveDataComponent.isOptionalField(tagId) || StipulationsComponent.isOptionalField(tagId) || SettlInstructionsDataComponent.isOptionalField(tagId)
  }
  ...
  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    ...
    InstrumentLegComponent.isFieldOf(tagId) || UnderlyingsGroup.isFieldOf(tagId) || TrdRegTimestampsComponent.isFieldOf(tagId) || 
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(CollateralInquiryMessage(myFields.get(CollInquiryIDField.TagId).flatMap(f=>CollInquiryIDField.decode(f)),
