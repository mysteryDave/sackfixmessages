...
/**
  ...
  */
case class MultilegOrderCancelReplaceRequestMessage(orderIDField:Option[OrderIDField]=None,
                                                    ...
                                                    multiLegRptTypeReqField:Option[MultiLegRptTypeReqField]=None) extends SfFixMessageBody("AC")  with SfFixRenderable with SfFixFieldsToAscii {
...
object MultilegOrderCancelReplaceRequestMessage extends SfFixMessageDecoder {
  val MsgType="AC"
  val MsgName="MultilegOrderCancelReplaceRequest"
             
  override val MandatoryFields = HashSet[Int](
    OrigClOrdIDField.TagId, ClOrdIDField.TagId, SideField.TagId, NoLegsField.TagId, TransactTimeField.TagId, 
    OrdTypeField.TagId)
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    UnderlyingsGroup.isMandatoryField(tagId) || LegsGroup.isMandatoryField(tagId) || OrderQtyDataComponent.isMandatoryField(tagId) || CommissionDataComponent.isMandatoryField(tagId) || 
  ...
  override val OptionalFields = HashSet[Int](
    ...
    BookingUnitField.TagId, PreallocMethodField.TagId, AllocIDField.TagId, NoAllocsField.TagId, SettlTypeField.TagId, 
    SettlDateField.TagId, CashMarginField.TagId, ClearingFeeIndicatorField.TagId, HandlInstField.TagId, ExecInstField.TagId, 
    MinQtyField.TagId, MaxFloorField.TagId, ExDestinationField.TagId, NoTradingSessionsField.TagId, ProcessCodeField.TagId, 
    NoUnderlyingsField.TagId, PrevClosePxField.TagId, LocateReqdField.TagId, QtyTypeField.TagId, PriceTypeField.TagId, 
    ...
    DesignationField.TagId, MultiLegRptTypeReqField.TagId)
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    UnderlyingsGroup.isOptionalField(tagId) || LegsGroup.isOptionalField(tagId) || OrderQtyDataComponent.isOptionalField(tagId) || CommissionDataComponent.isOptionalField(tagId) || 
  ...
  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
   ...
   override lazy val RepeatingGroupsTags = HashSet[Int](
    NoAllocsField.TagId, NoTradingSessionsField.TagId, NoUnderlyingsField.TagId, NoLegsField.TagId)
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(MultilegOrderCancelReplaceRequestMessage(myFields.get(OrderIDField.TagId).flatMap(f=>OrderIDField.decode(f)),
