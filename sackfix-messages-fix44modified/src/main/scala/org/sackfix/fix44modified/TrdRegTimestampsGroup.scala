...
case class TrdRegTimestampsGroup(trdRegTimestampField:Option[TrdRegTimestampField]=None,
                                 ...
                                 trdRegTimestampOriginField:Option[TrdRegTimestampOriginField]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
...
object TrdRegTimestampsGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    TrdRegTimestampField.TagId, TrdRegTimestampTypeField.TagId, TrdRegTimestampOriginField.TagId)
