...
case class ListStrikePriceMessage(listIDField:ListIDField,
                                  ...
                                  instrmtStrkPxGrpComponent:InstrmtStrkPxGrpComponent) extends SfFixMessageBody("m")  with SfFixRenderable with SfFixFieldsToAscii {
...
object ListStrikePriceMessage extends SfFixMessageDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    InstrmtStrkPxGrpComponent.isMandatoryField(tagId)
  }
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    InstrmtStrkPxGrpComponent.isOptionalField(tagId)
  }

  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    InstrmtStrkPxGrpComponent.isFieldOf(tagId)
