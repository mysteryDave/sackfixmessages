...
object MultilegOrderCancelReplaceMessage extends SfFixMessageDecoder {
  ...
  override val MandatoryFields = HashSet[Int](
    SideField.TagId, TransactTimeField.TagId, OrdTypeField.TagId)
  ...
  override val OptionalFields = HashSet[Int](
    OrderIDField.TagId, OrigClOrdIDField.TagId, ClOrdIDField.TagId, SecondaryClOrdIDField.TagId, ClOrdLinkIDField.TagId, 
    OrigOrdModTimeField.TagId, TradeOriginationDateField.TagId, TradeDateField.TagId, AccountField.TagId, AcctIDSourceField.TagId, 
    ...
    ExDestinationField.TagId, ExDestinationIDSourceField.TagId, ProcessCodeField.TagId, PrevClosePxField.TagId, SwapPointsField.TagId, 
    LocateReqdField.TagId, QtyTypeField.TagId, MultilegModelField.TagId, MultilegPriceMethodField.TagId, PriceTypeField.TagId, 
    PriceField.TagId, PriceProtectionScopeField.TagId, StopPxField.TagId, CurrencyField.TagId, ComplianceIDField.TagId, 
    SolicitedFlagField.TagId, IOIIDField.TagId, QuoteIDField.TagId, TimeInForceField.TagId, EffectiveTimeField.TagId, 
    ...
    MaxShowField.TagId, TargetStrategyField.TagId, TargetStrategyParametersField.TagId, RiskFreeRateField.TagId, ParticipationRateField.TagId, 
    CancellationRightsField.TagId, MoneyLaunderingStatusField.TagId, RegistIDField.TagId, DesignationField.TagId, MultiLegRptTypeReqField.TagId)
