...
/**
  ...
  */
case class TradingSessionStatusMessage(applicationSequenceControlComponent:Option[ApplicationSequenceControlComponent]=None,
                                       ...
                                       tradSesEventField:Option[TradSesEventField]=None,
  ...
  def format( fmt: ((StringBuilder,SfFixRenderable)=>Unit), b:StringBuilder = new StringBuilder()): StringBuilder = {
    ...
    tradSesEventField.foreach(fmt(b,_))
...
object TradingSessionStatusMessage extends SfFixMessageDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    ApplicationSequenceControlComponent.isMandatoryField(tagId) || InstrumentComponent.isMandatoryField(tagId)
  }

  override val OptionalFields = HashSet[Int](
    TradSesReqIDField.TagId, MarketIDField.TagId, MarketSegmentIDField.TagId, TradingSessionSubIDField.TagId, TradSesMethodField.TagId, 
    TradSesModeField.TagId, UnsolicitedIndicatorField.TagId, TradSesEventField.TagId, TradSesStatusRejReasonField.TagId, TradSesStartTimeField.TagId, 
    TradSesOpenTimeField.TagId, TradSesPreCloseTimeField.TagId, TradSesCloseTimeField.TagId, TradSesEndTimeField.TagId, TotalVolumeTradedField.TagId, 
    TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId)

  override def isOptionalField(tagId:Int) : Boolean = {
    OptionalFields.contains(tagId)  || 
    ApplicationSequenceControlComponent.isOptionalField(tagId) || InstrumentComponent.isOptionalField(tagId)
  }

  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    ApplicationSequenceControlComponent.isFieldOf(tagId) || InstrumentComponent.isFieldOf(tagId)
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(TradingSessionStatusMessage(ApplicationSequenceControlComponent.decode(flds, startPos),
        ...
        myFields.get(TradSesEventField.TagId).flatMap(f=>TradSesEventField.decode(f)),
