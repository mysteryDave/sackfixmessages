...
object AssignmentReportMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    ThresholdAmountField.TagId, SettlPriceField.TagId, SettlPriceTypeField.TagId, UnderlyingSettlPriceField.TagId, PriorSettlPriceField.TagId, 
    ExpireDateField.TagId, AssignmentMethodField.TagId, AssignmentUnitField.TagId, OpenInterestField.TagId, ExerciseMethodField.TagId, 
    SettlSessIDField.TagId, SettlSessSubIDField.TagId, TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId)
