...
case class QuoteEntriesGroup(quoteEntryIDField:QuoteEntryIDField,
                             ...
                             currencyField:Option[CurrencyField]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
...
object QuoteEntriesGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    BidForwardPoints2Field.TagId, OfferForwardPoints2Field.TagId, CurrencyField.TagId)
