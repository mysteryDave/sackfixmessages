...
object UnderlyingInstrumentComponent extends SfFixDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    UnderlyingMaturityTimeField.TagId, UnderlyingCouponPaymentDateField.TagId, UnderlyingIssueDateField.TagId, UnderlyingRepoCollateralSecurityTypeField.TagId, UnderlyingRepurchaseTermField.TagId, 
    ...
    UnderlyingOptAttributeField.TagId, UnderlyingContractMultiplierField.TagId, UnderlyingUnitOfMeasureField.TagId, UnderlyingUnitOfMeasureQtyField.TagId, UnderlyingPriceUnitOfMeasureField.TagId, 
    UnderlyingPriceUnitOfMeasureQtyField.TagId, UnderlyingTimeUnitField.TagId, UnderlyingExerciseStyleField.TagId, UnderlyingCouponRateField.TagId, UnderlyingSecurityExchangeField.TagId, 
    UnderlyingIssuerField.TagId, EncodedUnderlyingIssuerLenField.TagId, EncodedUnderlyingIssuerField.TagId, UnderlyingSecurityDescField.TagId, EncodedUnderlyingSecurityDescLenField.TagId, 
    EncodedUnderlyingSecurityDescField.TagId, UnderlyingCPProgramField.TagId, UnderlyingCPRegTypeField.TagId, UnderlyingAllocationPercentField.TagId, UnderlyingCurrencyField.TagId, 
    UnderlyingQtyField.TagId, UnderlyingSettlementTypeField.TagId, UnderlyingCashAmountField.TagId, UnderlyingCashTypeField.TagId, UnderlyingPxField.TagId, 
    ...
    UnderlyingAdjustedQuantityField.TagId, UnderlyingFXRateField.TagId, UnderlyingFXRateCalcField.TagId, UnderlyingCapValueField.TagId, UnderlyingSettlMethodField.TagId, 
    UnderlyingPutOrCallField.TagId)
