...
case class QuoteResponseMessage(quoteRespIDField:QuoteRespIDField,
                                ...
                                exDestinationIDSourceField:Option[ExDestinationIDSourceField]=None) extends SfFixMessageBody("AJ")  with SfFixRenderable with SfFixFieldsToAscii {
...
object QuoteResponseMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    TradingSessionIDField.TagId, TradingSessionSubIDField.TagId, SideField.TagId, SettlTypeField.TagId, SettlDateField.TagId, 
    SettlDate2Field.TagId, OrderQty2Field.TagId, CurrencyField.TagId, AccountField.TagId, AcctIDSourceField.TagId, 
    AccountTypeField.TagId, BidPxField.TagId, OfferPxField.TagId, MktBidPxField.TagId, MktOfferPxField.TagId, 
    ...
    CommissionField.TagId, CommTypeField.TagId, CustOrderCapacityField.TagId, ExDestinationField.TagId, TextField.TagId, 
    EncodedTextLenField.TagId, EncodedTextField.TagId, PriceField.TagId, PriceTypeField.TagId, ExDestinationIDSourceField.TagId)
