...
case class TradeCaptureReportRequestMessage(tradeRequestIDField:TradeRequestIDField,
                                            ...
                                            tradeHandlingInstrField:Option[TradeHandlingInstrField]=None) extends SfFixMessageBody("AD")  with SfFixRenderable with SfFixFieldsToAscii {
...
object TradeCaptureReportRequestMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    EncodedTextLenField.TagId, EncodedTextField.TagId, MessageEventSourceField.TagId, TradeIDField.TagId, SecondaryTradeIDField.TagId, 
    FirmTradeIDField.TagId, SecondaryFirmTradeIDField.TagId, TradeHandlingInstrField.TagId)
