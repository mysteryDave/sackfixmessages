...
/**
  ...
  */
case class Confirmation_AckMessage(confirmIDField:ConfirmIDField,
...
object Confirmation_AckMessage extends SfFixMessageDecoder {
  val MsgType="AU"
  val MsgName="Confirmation_Ack"
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(Confirmation_AckMessage(ConfirmIDField.decode(myFields.get(ConfirmIDField.TagId)).get,
