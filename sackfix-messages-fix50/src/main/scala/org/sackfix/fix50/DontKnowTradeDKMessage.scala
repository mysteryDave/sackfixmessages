...
/**
  ...
  */
case class DontKnowTradeDKMessage(orderIDField:OrderIDField,
...
object DontKnowTradeDKMessage extends SfFixMessageDecoder {
  val MsgType="Q"
  val MsgName="DontKnowTradeDK"
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(DontKnowTradeDKMessage(OrderIDField.decode(myFields.get(OrderIDField.TagId)).get,
