...
/**
  ...
  */
case class TradingSessionsGroup(tradingSessionIDField:TradingSessionIDField,
...
object TradingSessionsGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    TradingSessionSubIDField.TagId, SecurityExchangeField.TagId, TradSesMethodField.TagId, TradSesModeField.TagId, UnsolicitedIndicatorField.TagId, 
  ...
  def decodeSingle(flds: Seq[Tuple2[Int, Any]], startPos:Int):Tuple2[Int,Option[TradingSessionsGroup]] = {
    if (!isFirstField(flds(startPos)._1)) (startPos, None)
      ...
      if (myFields.nonEmpty) {
        (pos,Some(TradingSessionsGroup(TradingSessionIDField.decode(myFields.get(TradingSessionIDField.TagId)).get,
