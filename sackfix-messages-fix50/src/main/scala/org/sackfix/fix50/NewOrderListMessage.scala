...
case class NewOrderListMessage(listIDField:ListIDField,
                               ...
                               listOrdGrpComponent:ListOrdGrpComponent,
                               rootPartiesComponent:Option[RootPartiesComponent]=None) extends SfFixMessageBody("E")  with SfFixRenderable with SfFixFieldsToAscii {
...
object NewOrderListMessage extends SfFixMessageDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    ListOrdGrpComponent.isMandatoryField(tagId) || RootPartiesComponent.isMandatoryField(tagId)
  }
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    ListOrdGrpComponent.isOptionalField(tagId) || RootPartiesComponent.isOptionalField(tagId)
  }

  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    ListOrdGrpComponent.isFieldOf(tagId) || RootPartiesComponent.isFieldOf(tagId)
