...
case class NewOrderCrossMessage(crossIDField:CrossIDField,
                                ...
                                exDestinationIDSourceField:Option[ExDestinationIDSourceField]=None) extends SfFixMessageBody("s")  with SfFixRenderable with SfFixFieldsToAscii {
...
object NewOrderCrossMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    TransBkdTimeField.TagId, MatchIncrementField.TagId, MaxPriceLevelsField.TagId, PriceProtectionScopeField.TagId, ExDestinationIDSourceField.TagId)
