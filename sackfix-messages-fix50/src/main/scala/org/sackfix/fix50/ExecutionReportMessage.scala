...
case class ExecutionReportMessage(orderIDField:OrderIDField,
                                  ...
                                  displayInstructionComponent:Option[DisplayInstructionComponent]=None) extends SfFixMessageBody("8")  with SfFixRenderable with SfFixFieldsToAscii {
...
object ExecutionReportMessage extends SfFixMessageDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    PartiesComponent.isMandatoryField(tagId) || ContraGrpComponent.isMandatoryField(tagId) || InstrumentComponent.isMandatoryField(tagId) || FinancingDetailsComponent.isMandatoryField(tagId) || 
    UndInstrmtGrpComponent.isMandatoryField(tagId) || StipulationsComponent.isMandatoryField(tagId) || OrderQtyDataComponent.isMandatoryField(tagId) || PegInstructionsComponent.isMandatoryField(tagId) || 
    ...
    ContAmtGrpComponent.isMandatoryField(tagId) || InstrmtLegExecGrpComponent.isMandatoryField(tagId) || MiscFeesGrpComponent.isMandatoryField(tagId) || StrategyParametersGrpComponent.isMandatoryField(tagId) || 
    TrdRegTimestampsComponent.isMandatoryField(tagId) || TriggeringInstructionComponent.isMandatoryField(tagId) || DisplayInstructionComponent.isMandatoryField(tagId)
  }
  ...
  override val OptionalFields = HashSet[Int](
    ...
    LastRptRequestedField.TagId, TradeOriginationDateField.TagId, ListIDField.TagId, CrossIDField.TagId, OrigCrossIDField.TagId, 
    CrossTypeField.TagId, ExecRefIDField.TagId, WorkingIndicatorField.TagId, OrdRejReasonField.TagId, ExecRestatementReasonField.TagId, 
    AccountField.TagId, AcctIDSourceField.TagId, AccountTypeField.TagId, DayBookingInstField.TagId, BookingUnitField.TagId, 
    PreallocMethodField.TagId, SettlTypeField.TagId, SettlDateField.TagId, CashMarginField.TagId, ClearingFeeIndicatorField.TagId, 
    QtyTypeField.TagId, OrdTypeField.TagId, PriceTypeField.TagId, PriceField.TagId, StopPxField.TagId, 
    PeggedPriceField.TagId, DiscretionPriceField.TagId, TargetStrategyField.TagId, TargetStrategyParametersField.TagId, ParticipationRateField.TagId, 
    TargetStrategyPerformanceField.TagId, CurrencyField.TagId, ComplianceIDField.TagId, SolicitedFlagField.TagId, TimeInForceField.TagId, 
    EffectiveTimeField.TagId, ExpireDateField.TagId, ExpireTimeField.TagId, ExecInstField.TagId, OrderCapacityField.TagId, 
    OrderRestrictionsField.TagId, CustOrderCapacityField.TagId, LastQtyField.TagId, UnderlyingLastQtyField.TagId, LastPxField.TagId, 
    UnderlyingLastPxField.TagId, LastParPxField.TagId, LastSpotRateField.TagId, LastForwardPointsField.TagId, LastMktField.TagId, 
    TradingSessionIDField.TagId, TradingSessionSubIDField.TagId, TimeBracketField.TagId, LastCapacityField.TagId, AvgPxField.TagId, 
    ...
    AccruedInterestRateField.TagId, AccruedInterestAmtField.TagId, InterestAtMaturityField.TagId, EndAccruedInterestAmtField.TagId, StartCashField.TagId, 
    EndCashField.TagId, TradedFlatSwitchField.TagId, BasisFeatureDateField.TagId, BasisFeaturePriceField.TagId, ConcessionField.TagId, 
    TotalTakedownField.TagId, NetMoneyField.TagId, SettlCurrAmtField.TagId, SettlCurrencyField.TagId, SettlCurrFxRateField.TagId, 
    SettlCurrFxRateCalcField.TagId, HandlInstField.TagId, MinQtyField.TagId, MaxFloorField.TagId, PositionEffectField.TagId, 
    MaxShowField.TagId, BookingTypeField.TagId, TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId, 
    SettlDate2Field.TagId, OrderQty2Field.TagId, LastForwardPoints2Field.TagId, MultiLegReportingTypeField.TagId, CancellationRightsField.TagId, 
    ...
    ExecPriceTypeField.TagId, ExecPriceAdjustmentField.TagId, PriorityIndicatorField.TagId, PriceImprovementField.TagId, LastLiquidityIndField.TagId, 
    CopyMsgIndicatorField.TagId, HostCrossIDField.TagId, ManualOrderIndicatorField.TagId, CustDirectedOrderField.TagId, ReceivedDeptIDField.TagId, 
    CustOrderHandlingInstField.TagId, OrderHandlingInstSourceField.TagId, AggressorIndicatorField.TagId, CalculatedCcyLastQtyField.TagId, LastSwapPointsField.TagId, 
    MatchTypeField.TagId, OrderCategoryField.TagId, LotTypeField.TagId, PriceProtectionScopeField.TagId, PeggedRefPriceField.TagId, 
    PreTradeAnonymityField.TagId, MatchIncrementField.TagId, MaxPriceLevelsField.TagId)

  override def isOptionalField(tagId:Int) : Boolean = {
    OptionalFields.contains(tagId)  || 
    PartiesComponent.isOptionalField(tagId) || ContraGrpComponent.isOptionalField(tagId) || InstrumentComponent.isOptionalField(tagId) || FinancingDetailsComponent.isOptionalField(tagId) || 
    UndInstrmtGrpComponent.isOptionalField(tagId) || StipulationsComponent.isOptionalField(tagId) || OrderQtyDataComponent.isOptionalField(tagId) || PegInstructionsComponent.isOptionalField(tagId) || 
    ...
    ContAmtGrpComponent.isOptionalField(tagId) || InstrmtLegExecGrpComponent.isOptionalField(tagId) || MiscFeesGrpComponent.isOptionalField(tagId) || StrategyParametersGrpComponent.isOptionalField(tagId) || 
    TrdRegTimestampsComponent.isOptionalField(tagId) || TriggeringInstructionComponent.isOptionalField(tagId) || DisplayInstructionComponent.isOptionalField(tagId)
  }

  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    PartiesComponent.isFieldOf(tagId) || ContraGrpComponent.isFieldOf(tagId) || InstrumentComponent.isFieldOf(tagId) || 
    FinancingDetailsComponent.isFieldOf(tagId) || UndInstrmtGrpComponent.isFieldOf(tagId) || StipulationsComponent.isFieldOf(tagId) || 
    ...
    StrategyParametersGrpComponent.isFieldOf(tagId) || TrdRegTimestampsComponent.isFieldOf(tagId) || TriggeringInstructionComponent.isFieldOf(tagId) || 
    DisplayInstructionComponent.isFieldOf(tagId)
