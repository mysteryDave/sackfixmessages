...
case class CollateralResponseMessage(collRespIDField:CollRespIDField,
                                     ...
                                     clearingBusinessDateField:Option[ClearingBusinessDateField]=None) extends SfFixMessageBody("AZ")  with SfFixRenderable with SfFixFieldsToAscii {
...
object CollateralResponseMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    SecondaryClOrdIDField.TagId, SettlDateField.TagId, QuantityField.TagId, QtyTypeField.TagId, CurrencyField.TagId, 
    MarginExcessField.TagId, TotalNetValueField.TagId, CashOutstandingField.TagId, SideField.TagId, PriceField.TagId, 
    PriceTypeField.TagId, AccruedInterestAmtField.TagId, EndAccruedInterestAmtField.TagId, StartCashField.TagId, EndCashField.TagId, 
    TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId, CollApplTypeField.TagId, FinancialStatusField.TagId, 
