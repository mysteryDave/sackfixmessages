...
case class QuoteStatusReportMessage(quoteStatusReqIDField:Option[QuoteStatusReqIDField]=None,
                                    ...
                                    exDestinationIDSourceField:Option[ExDestinationIDSourceField]=None) extends SfFixMessageBody("AI")  with SfFixRenderable with SfFixFieldsToAscii {
...
object QuoteStatusReportMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    ExpireTimeField.TagId, PriceField.TagId, PriceTypeField.TagId, BidPxField.TagId, OfferPxField.TagId, 
    ...
    ExDestinationField.TagId, QuoteStatusField.TagId, TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId, 
