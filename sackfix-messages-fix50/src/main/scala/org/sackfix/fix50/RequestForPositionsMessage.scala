...
case class RequestForPositionsMessage(posReqIDField:PosReqIDField,
                                      ...
                                      settlCurrencyField:Option[SettlCurrencyField]=None) extends SfFixMessageBody("AN")  with SfFixRenderable with SfFixFieldsToAscii {
...
object RequestForPositionsMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    MatchStatusField.TagId, SubscriptionRequestTypeField.TagId, AccountField.TagId, AcctIDSourceField.TagId, AccountTypeField.TagId, 
    CurrencyField.TagId, SettlSessIDField.TagId, SettlSessSubIDField.TagId, ResponseTransportTypeField.TagId, ResponseDestinationField.TagId, 
    TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId, SettlCurrencyField.TagId)
