...
/**
  ...
  */
case class IOIMessage(iOIIDField:IOIIDField,
                      ...
                      partiesComponent:Option[PartiesComponent]=None) extends SfFixMessageBody("6")  with SfFixRenderable with SfFixFieldsToAscii {
...
object IOIMessage extends SfFixMessageDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    StipulationsComponent.isMandatoryField(tagId) || InstrmtLegIOIGrpComponent.isMandatoryField(tagId) || IOIQualGrpComponent.isMandatoryField(tagId) || RoutingGrpComponent.isMandatoryField(tagId) || 
    SpreadOrBenchmarkCurveDataComponent.isMandatoryField(tagId) || YieldDataComponent.isMandatoryField(tagId) || PartiesComponent.isMandatoryField(tagId)
  }
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    StipulationsComponent.isOptionalField(tagId) || InstrmtLegIOIGrpComponent.isOptionalField(tagId) || IOIQualGrpComponent.isOptionalField(tagId) || RoutingGrpComponent.isOptionalField(tagId) || 
    SpreadOrBenchmarkCurveDataComponent.isOptionalField(tagId) || YieldDataComponent.isOptionalField(tagId) || PartiesComponent.isOptionalField(tagId)
  }
  ...
  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    ...
    OrderQtyDataComponent.isFieldOf(tagId) || StipulationsComponent.isFieldOf(tagId) || InstrmtLegIOIGrpComponent.isFieldOf(tagId) || 
    IOIQualGrpComponent.isFieldOf(tagId) || RoutingGrpComponent.isFieldOf(tagId) || SpreadOrBenchmarkCurveDataComponent.isFieldOf(tagId) || 
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(IOIMessage(IOIIDField.decode(myFields.get(IOIIDField.TagId)).get,
