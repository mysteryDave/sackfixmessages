...
case class NewOrderMultilegMessage(clOrdIDField:ClOrdIDField,
                                   ...
                                   exDestinationIDSourceField:Option[ExDestinationIDSourceField]=None) extends SfFixMessageBody("AB")  with SfFixRenderable with SfFixFieldsToAscii {
...
object NewOrderMultilegMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    DesignationField.TagId, MultiLegRptTypeReqField.TagId, SwapPointsField.TagId, MatchIncrementField.TagId, MaxPriceLevelsField.TagId, 
    PriceProtectionScopeField.TagId, RefOrderIDField.TagId, RefOrderIDSourceField.TagId, PreTradeAnonymityField.TagId, ExDestinationIDSourceField.TagId)
