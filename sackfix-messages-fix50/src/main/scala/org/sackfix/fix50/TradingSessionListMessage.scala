...
/**
  ...
  */
case class TradingSessionListMessage(tradSesReqIDField:Option[TradSesReqIDField]=None,
...
object TradingSessionListMessage extends SfFixMessageDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    TrdSessLstGrpComponent.isMandatoryField(tagId)
  }
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    TrdSessLstGrpComponent.isOptionalField(tagId)
  }

  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    TrdSessLstGrpComponent.isFieldOf(tagId)
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(TradingSessionListMessage(myFields.get(TradSesReqIDField.TagId).flatMap(f=>TradSesReqIDField.decode(f)),
