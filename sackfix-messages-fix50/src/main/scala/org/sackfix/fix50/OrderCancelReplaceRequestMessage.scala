...
case class OrderCancelReplaceRequestMessage(orderIDField:Option[OrderIDField]=None,
                                            ...
                                            exDestinationIDSourceField:Option[ExDestinationIDSourceField]=None) extends SfFixMessageBody("G")  with SfFixRenderable with SfFixFieldsToAscii {
...
object OrderCancelReplaceRequestMessage extends SfFixMessageDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    PartiesComponent.isMandatoryField(tagId) || PreAllocGrpComponent.isMandatoryField(tagId) || TrdgSesGrpComponent.isMandatoryField(tagId) || InstrumentComponent.isMandatoryField(tagId) || 
    FinancingDetailsComponent.isMandatoryField(tagId) || UndInstrmtGrpComponent.isMandatoryField(tagId) || OrderQtyDataComponent.isMandatoryField(tagId) || SpreadOrBenchmarkCurveDataComponent.isMandatoryField(tagId) || 
    ...
    StrategyParametersGrpComponent.isMandatoryField(tagId) || TrdRegTimestampsComponent.isMandatoryField(tagId) || DisplayInstructionComponent.isMandatoryField(tagId) || TriggeringInstructionComponent.isMandatoryField(tagId)
  }
  ...
  override val OptionalFields = HashSet[Int](
    ...
    SettlDateField.TagId, CashMarginField.TagId, ClearingFeeIndicatorField.TagId, HandlInstField.TagId, ExecInstField.TagId, 
    MinQtyField.TagId, MaxFloorField.TagId, ExDestinationField.TagId, QtyTypeField.TagId, PriceTypeField.TagId, 
    PriceField.TagId, StopPxField.TagId, TargetStrategyField.TagId, TargetStrategyParametersField.TagId, ParticipationRateField.TagId, 
    ...
    PositionEffectField.TagId, CoveredOrUncoveredField.TagId, MaxShowField.TagId, LocateReqdField.TagId, CancellationRightsField.TagId, 
    MoneyLaunderingStatusField.TagId, RegistIDField.TagId, DesignationField.TagId, ManualOrderIndicatorField.TagId, CustDirectedOrderField.TagId, 
    ReceivedDeptIDField.TagId, CustOrderHandlingInstField.TagId, OrderHandlingInstSourceField.TagId, MatchIncrementField.TagId, MaxPriceLevelsField.TagId, 
    PriceProtectionScopeField.TagId, PreTradeAnonymityField.TagId, ExDestinationIDSourceField.TagId)

  override def isOptionalField(tagId:Int) : Boolean = {
    OptionalFields.contains(tagId)  || 
    PartiesComponent.isOptionalField(tagId) || PreAllocGrpComponent.isOptionalField(tagId) || TrdgSesGrpComponent.isOptionalField(tagId) || InstrumentComponent.isOptionalField(tagId) || 
    FinancingDetailsComponent.isOptionalField(tagId) || UndInstrmtGrpComponent.isOptionalField(tagId) || OrderQtyDataComponent.isOptionalField(tagId) || SpreadOrBenchmarkCurveDataComponent.isOptionalField(tagId) || 
    ...
    StrategyParametersGrpComponent.isOptionalField(tagId) || TrdRegTimestampsComponent.isOptionalField(tagId) || DisplayInstructionComponent.isOptionalField(tagId) || TriggeringInstructionComponent.isOptionalField(tagId)
  }

  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    PartiesComponent.isFieldOf(tagId) || PreAllocGrpComponent.isFieldOf(tagId) || TrdgSesGrpComponent.isFieldOf(tagId) || 
    ...
    StrategyParametersGrpComponent.isFieldOf(tagId) || TrdRegTimestampsComponent.isFieldOf(tagId) || DisplayInstructionComponent.isFieldOf(tagId) || 
