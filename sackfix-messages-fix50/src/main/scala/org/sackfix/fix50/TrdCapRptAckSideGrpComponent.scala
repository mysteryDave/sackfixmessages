...
/**
  ...
  */
case class TrdCapRptAckSideGrpComponent(noSidesField:NoSidesField,
...
object TrdCapRptAckSideGrpComponent extends SfFixDecoder {
  ...
  def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[TrdCapRptAckSideGrpComponent] = {
    val (pos, myFields, nextTagPosLookup) = extractMyFieldsAndPopulatePositions(false, flds, startPos)
    validateMandatoryFieldsPresent(myFields)

    if (myFields.nonEmpty) {
      Some(TrdCapRptAckSideGrpComponent(NoSidesField.decode(myFields.get(NoSidesField.TagId)).get,
