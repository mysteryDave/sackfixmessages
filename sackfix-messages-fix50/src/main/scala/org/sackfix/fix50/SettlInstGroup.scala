...
case class SettlInstGroup(settlInstIDField:Option[SettlInstIDField]=None,
                          ...
                          paymentRemitterIDField:Option[PaymentRemitterIDField]=None,
                          settlCurrencyField:Option[SettlCurrencyField]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
...
object SettlInstGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    CardExpDateField.TagId, CardIssNumField.TagId, PaymentDateField.TagId, PaymentRemitterIDField.TagId, SettlCurrencyField.TagId)
