...
case class NewOrderSingleMessage(clOrdIDField:ClOrdIDField,
                                 ...
                                 exDestinationIDSourceField:Option[ExDestinationIDSourceField]=None) extends SfFixMessageBody("D")  with SfFixRenderable with SfFixFieldsToAscii {
...
object NewOrderSingleMessage extends SfFixMessageDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    FinancingDetailsComponent.isMandatoryField(tagId) || UndInstrmtGrpComponent.isMandatoryField(tagId) || StipulationsComponent.isMandatoryField(tagId) || OrderQtyDataComponent.isMandatoryField(tagId) || 
    ...
    DiscretionInstructionsComponent.isMandatoryField(tagId) || StrategyParametersGrpComponent.isMandatoryField(tagId) || TrdRegTimestampsComponent.isMandatoryField(tagId) || DisplayInstructionComponent.isMandatoryField(tagId) || 
  ...
  override val OptionalFields = HashSet[Int](
    ...
    ProcessCodeField.TagId, PrevClosePxField.TagId, LocateReqdField.TagId, QtyTypeField.TagId, PriceTypeField.TagId, 
    PriceField.TagId, StopPxField.TagId, CurrencyField.TagId, ComplianceIDField.TagId, SolicitedFlagField.TagId, 
    IOIIDField.TagId, QuoteIDField.TagId, TimeInForceField.TagId, EffectiveTimeField.TagId, ExpireDateField.TagId, 
    ExpireTimeField.TagId, GTBookingInstField.TagId, OrderCapacityField.TagId, OrderRestrictionsField.TagId, CustOrderCapacityField.TagId, 
    ...
    CustDirectedOrderField.TagId, ReceivedDeptIDField.TagId, CustOrderHandlingInstField.TagId, OrderHandlingInstSourceField.TagId, MatchIncrementField.TagId, 
    MaxPriceLevelsField.TagId, PriceProtectionScopeField.TagId, PreTradeAnonymityField.TagId, RefOrderIDField.TagId, RefOrderIDSourceField.TagId, 
    ExDestinationIDSourceField.TagId)
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    FinancingDetailsComponent.isOptionalField(tagId) || UndInstrmtGrpComponent.isOptionalField(tagId) || StipulationsComponent.isOptionalField(tagId) || OrderQtyDataComponent.isOptionalField(tagId) || 
    ...
    DiscretionInstructionsComponent.isOptionalField(tagId) || StrategyParametersGrpComponent.isOptionalField(tagId) || TrdRegTimestampsComponent.isOptionalField(tagId) || DisplayInstructionComponent.isOptionalField(tagId) || 
  ...
  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    ...
    DiscretionInstructionsComponent.isFieldOf(tagId) || StrategyParametersGrpComponent.isFieldOf(tagId) || TrdRegTimestampsComponent.isFieldOf(tagId) || 
