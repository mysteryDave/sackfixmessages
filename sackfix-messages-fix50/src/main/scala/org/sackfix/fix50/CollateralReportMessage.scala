...
case class CollateralReportMessage(collRptIDField:CollRptIDField,
                                   ...
                                   financialStatusField:Option[FinancialStatusField]=None) extends SfFixMessageBody("BA")  with SfFixRenderable with SfFixFieldsToAscii {
...
object CollateralReportMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    EncodedTextField.TagId, TransactTimeField.TagId, CollApplTypeField.TagId, FinancialStatusField.TagId)
