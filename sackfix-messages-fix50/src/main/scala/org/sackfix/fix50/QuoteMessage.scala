...
object QuoteMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    QuoteReqIDField.TagId, QuoteRespIDField.TagId, QuoteTypeField.TagId, QuoteResponseLevelField.TagId, TradingSessionIDField.TagId, 
    TradingSessionSubIDField.TagId, SideField.TagId, SettlTypeField.TagId, SettlDateField.TagId, SettlDate2Field.TagId, 
    ...
    CommissionField.TagId, CustOrderCapacityField.TagId, ExDestinationField.TagId, OrderCapacityField.TagId, PriceTypeField.TagId, 
    TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId, BidSwapPointsField.TagId, OfferSwapPointsField.TagId, 
