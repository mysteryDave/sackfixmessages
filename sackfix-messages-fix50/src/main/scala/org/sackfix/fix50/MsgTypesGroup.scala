...
case class MsgTypesGroup(refMsgTypeField:Option[RefMsgTypeField]=None,
                         ...
                         refCstmApplVerIDField:Option[RefCstmApplVerIDField]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
...
object MsgTypesGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    RefMsgTypeField.TagId, MsgDirectionField.TagId, RefApplVerIDField.TagId, RefCstmApplVerIDField.TagId)
