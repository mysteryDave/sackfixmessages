...
/**
  ...
  */
case class StrikesGroup(instrumentComponent:Option[InstrumentComponent]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
  ...
  def decodeSingle(flds: Seq[Tuple2[Int, Any]], startPos:Int):Tuple2[Int,Option[StrikesGroup]] = {
    if (!isFirstField(flds(startPos)._1)) (startPos, None)
      ...
      if (myFields.nonEmpty) {
        (pos,Some(StrikesGroup(InstrumentComponent.decode(flds, startPos))))
      } else (startPos, None)
    }
  }
