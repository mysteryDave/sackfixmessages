...
case class SettlementInstructionRequestMessage(settlInstReqIDField:SettlInstReqIDField,
                                               ...
                                               settlCurrencyField:Option[SettlCurrencyField]=None) extends SfFixMessageBody("AV")  with SfFixRenderable with SfFixFieldsToAscii {
...
object SettlementInstructionRequestMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    StandInstDbNameField.TagId, StandInstDbIDField.TagId, SettlCurrencyField.TagId)
