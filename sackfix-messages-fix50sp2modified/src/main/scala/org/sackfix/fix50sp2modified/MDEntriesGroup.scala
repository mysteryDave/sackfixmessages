...
case class MDEntriesGroup(mDUpdateActionField:MDUpdateActionField,
                          ...
                          dealingCapacityStringField:Option[DealingCapacityStringField]=None,
  ...
  def format( fmt: ((StringBuilder,SfFixRenderable)=>Unit), b:StringBuilder = new StringBuilder()): StringBuilder = {
    ...
    dealingCapacityStringField.foreach(fmt(b,_))
...
object MDEntriesGroup extends SfGroupDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    SpreadOrBenchmarkCurveDataComponent.isMandatoryField(tagId) || RateSourceComponent.isMandatoryField(tagId) || SecSizesGrpComponent.isMandatoryField(tagId) || StatsIndGrpComponent.isMandatoryField(tagId) || 
  ...
  override val OptionalFields = HashSet[Int](
    ...
    MDEntryRefIDField.TagId, MDStreamIDField.TagId, FinancialStatusField.TagId, CorporateActionField.TagId, MDEntryPxField.TagId, 
    PriceTypeField.TagId, OrdTypeField.TagId, CurrencyField.TagId, SettlCurrencyField.TagId, MDEntrySizeField.TagId, 
    LotTypeField.TagId, MDEntryDateField.TagId, MDEntryTimeField.TagId, TickDirectionField.TagId, MDMktField.TagId, 
    TradingSessionIDField.TagId, TradingSessionSubIDField.TagId, SecurityTradingStatusField.TagId, HaltReasonIntField.TagId, QuoteConditionField.TagId, 
    TradeConditionField.TagId, TrdTypeField.TagId, MatchTypeField.TagId, MDEntryOriginatorField.TagId, LocationIDField.TagId, 
    DeskIDField.TagId, OpenCloseSettlFlagField.TagId, TimeInForceField.TagId, ExpireDateField.TagId, ExpireTimeField.TagId, 
    MinQtyField.TagId, ExecInstField.TagId, SellerDaysField.TagId, OrderIDField.TagId, SecondaryOrderIDField.TagId, 
    QuoteEntryIDField.TagId, TradeIDField.TagId, MDEntryBuyerField.TagId, MDEntrySellerField.TagId, NumberOfOrdersField.TagId, 
    MDEntryPositionNoField.TagId, ScopeField.TagId, PriceDeltaField.TagId, NetChgPrevDayField.TagId, TextField.TagId, 
    EncodedTextLenField.TagId, EncodedTextField.TagId, MDPriceLevelField.TagId, OrderCapacityField.TagId, MDOriginTypeField.TagId, 
    HighPxField.TagId, LowPxField.TagId, FirstPxField.TagId, LastPxField.TagId, TradeVolumeField.TagId, 
    SettlTypeField.TagId, SettlDateField.TagId, TransBkdTimeField.TagId, TransactTimeField.TagId, MDQuoteTypeField.TagId, 
    RptSeqField.TagId, DealingCapacityStringField.TagId, MDEntrySpotRateField.TagId, MDEntryForwardPointsField.TagId)
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    SpreadOrBenchmarkCurveDataComponent.isOptionalField(tagId) || RateSourceComponent.isOptionalField(tagId) || SecSizesGrpComponent.isOptionalField(tagId) || StatsIndGrpComponent.isOptionalField(tagId) || 
  ...
  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    ...
    YieldDataComponent.isFieldOf(tagId) || SpreadOrBenchmarkCurveDataComponent.isFieldOf(tagId) || RateSourceComponent.isFieldOf(tagId) || 
    SecSizesGrpComponent.isFieldOf(tagId) || StatsIndGrpComponent.isFieldOf(tagId) || PartiesComponent.isFieldOf(tagId)
    ...
    if (!isFirstField(flds(startPos)._1)) (startPos, None)
      ...
      if (myFields.nonEmpty) {
        (pos,Some(MDEntriesGroup(MDUpdateActionField.decode(myFields.get(MDUpdateActionField.TagId)).get,
          ...
          myFields.get(DealingCapacityStringField.TagId).flatMap(f=>DealingCapacityStringField.decode(f)),
