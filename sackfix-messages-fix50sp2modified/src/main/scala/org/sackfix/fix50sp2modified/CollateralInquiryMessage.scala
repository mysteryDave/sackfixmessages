...
/**
  ...
  */
case class CollateralInquiryMessage(collInquiryIDField:CollInquiryIDField,
...
object CollateralInquiryMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    SubscriptionRequestTypeField.TagId, ResponseTransportTypeField.TagId, ResponseDestinationField.TagId, AccountField.TagId, AccountTypeField.TagId, 
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(CollateralInquiryMessage(CollInquiryIDField.decode(myFields.get(CollInquiryIDField.TagId)).get,
