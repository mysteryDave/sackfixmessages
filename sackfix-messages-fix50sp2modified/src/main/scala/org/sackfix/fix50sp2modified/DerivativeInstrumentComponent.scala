...
case class DerivativeInstrumentComponent(derivativeSymbolField:Option[DerivativeSymbolField]=None,
                                         ...
                                         derivativeContractMultiplierUnitField:Option[DerivativeContractMultiplierUnitField]=None,
                                         derivativeFlowScheduleTypeField:Option[DerivativeFlowScheduleTypeField]=None,
                                         ...
                                         derivativeValuationMethodField:Option[DerivativeValuationMethodField]=None,
  ...
  def format( fmt: ((StringBuilder,SfFixRenderable)=>Unit), b:StringBuilder = new StringBuilder()): StringBuilder = {
    ...
    derivativeContractMultiplierUnitField.foreach(fmt(b,_))
    derivativeFlowScheduleTypeField.foreach(fmt(b,_))
    ...
    derivativeValuationMethodField.foreach(fmt(b,_))
...
object DerivativeInstrumentComponent extends SfFixDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    DerivativeStrikeValueField.TagId, DerivativeOptAttributeField.TagId, DerivativeContractMultiplierField.TagId, DerivativeContractMultiplierUnitField.TagId, DerivativeFlowScheduleTypeField.TagId, 
    DerivativeMinPriceIncrementField.TagId, DerivativeMinPriceIncrementAmountField.TagId, DerivativeUnitOfMeasureField.TagId, DerivativeUnitOfMeasureQtyField.TagId, DerivativePriceUnitOfMeasureField.TagId, 
    DerivativePriceUnitOfMeasureQtyField.TagId, DerivativeSettlMethodField.TagId, DerivativePriceQuoteMethodField.TagId, DerivativeValuationMethodField.TagId, DerivativeListMethodField.TagId, 
    DerivativeCapPriceField.TagId, DerivativeFloorPriceField.TagId, DerivativePutOrCallField.TagId, DerivativeExerciseStyleField.TagId, DerivativeOptPayAmountField.TagId, 
    DerivativeTimeUnitField.TagId, DerivativeSecurityExchangeField.TagId, DerivativePositionLimitField.TagId, DerivativeNTPositionLimitField.TagId, DerivativeIssuerField.TagId, 
    DerivativeEncodedIssuerLenField.TagId, DerivativeEncodedIssuerField.TagId, DerivativeSecurityDescField.TagId, DerivativeEncodedSecurityDescLenField.TagId, DerivativeEncodedSecurityDescField.TagId, 
    DerivativeContractSettlMonthField.TagId)
  ...
  def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[DerivativeInstrumentComponent] = {
    ...
    if (myFields.nonEmpty) {
      Some(DerivativeInstrumentComponent(myFields.get(DerivativeSymbolField.TagId).flatMap(f=>DerivativeSymbolField.decode(f)),
        ...
        myFields.get(DerivativeContractMultiplierUnitField.TagId).flatMap(f=>DerivativeContractMultiplierUnitField.decode(f)),
        myFields.get(DerivativeFlowScheduleTypeField.TagId).flatMap(f=>DerivativeFlowScheduleTypeField.decode(f)),
        ...
        myFields.get(DerivativeValuationMethodField.TagId).flatMap(f=>DerivativeValuationMethodField.decode(f)),
