...
case class AllocationReportMessage(allocReportIDField:AllocReportIDField,
                                   ...
                                   rateSourceComponent:Option[RateSourceComponent]=None) extends SfFixMessageBody("AS")  with SfFixRenderable with SfFixFieldsToAscii {
...
object AllocationReportMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    ClearingBusinessDateField.TagId, TrdTypeField.TagId, TrdSubTypeField.TagId, MultiLegReportingTypeField.TagId, CustOrderCapacityField.TagId, 
    TradeInputSourceField.TagId, RndPxField.TagId, MessageEventSourceField.TagId, TradeInputDeviceField.TagId, AvgPxIndicatorField.TagId, 
