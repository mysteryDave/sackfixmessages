...
/**
  ...
  */
case class ExecsGroup(lastSharesIntField:Option[LastSharesIntField]=None,
...
object ExecsGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    LastSharesIntField.TagId, ExecIDField.TagId, LastPxField.TagId, LastCapacityField.TagId)
  ...
  override def isFirstField(tagId:Int) : Boolean = tagId==LastSharesIntField.TagId 
  ...
  def decodeSingle(flds: Seq[Tuple2[Int, Any]], startPos:Int):Tuple2[Int,Option[ExecsGroup]] = {
    if (!isFirstField(flds(startPos)._1)) (startPos, None)
      ...
      if (myFields.nonEmpty) {
        (pos,Some(ExecsGroup(myFields.get(LastSharesIntField.TagId).flatMap(f=>LastSharesIntField.decode(f)),
