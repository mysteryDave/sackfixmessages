...
object QuoteEntriesGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    QuoteEntryIDField.TagId, BidPxField.TagId, OfferPxField.TagId, BidSizeField.TagId, OfferSizeField.TagId, 
    ...
    TradingSessionIDField.TagId, TradingSessionSubIDField.TagId, FutSettDateField.TagId, OrdTypeField.TagId, FutSettDate2Field.TagId, 
    OrderQty2Field.TagId, BidForwardPoints2Field.TagId, OfferForwardPoints2Field.TagId, CurrencyField.TagId, QuoteEntryRejectReasonField.TagId)
