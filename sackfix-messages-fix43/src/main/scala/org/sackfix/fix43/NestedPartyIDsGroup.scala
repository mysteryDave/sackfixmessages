...
case class NestedPartyIDsGroup(nestedPartyIDField:Option[NestedPartyIDField]=None,
                               ...
                               nestedPartySubIDField:Option[NestedPartySubIDField]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
...
object NestedPartyIDsGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    NestedPartyIDField.TagId, NestedPartyIDSourceField.TagId, NestedPartyRoleField.TagId, NestedPartySubIDField.TagId)
    ...
    if (!isFirstField(flds(startPos)._1)) (startPos, None)
      ...
      if (myFields.nonEmpty) {
        (pos,Some(NestedPartyIDsGroup(myFields.get(NestedPartyIDField.TagId).flatMap(f=>NestedPartyIDField.decode(f)),
          ...
          myFields.get(NestedPartySubIDField.TagId).flatMap(f=>NestedPartySubIDField.decode(f)))))
      } else (startPos, None)
    }
  }
