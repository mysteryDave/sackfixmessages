...
case class MiscFeesGroup(miscFeeAmtField:Option[MiscFeeAmtField]=None,
                         ...
                         miscFeeTypeField:Option[MiscFeeTypeField]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
...
object MiscFeesGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    MiscFeeAmtField.TagId, MiscFeeCurrField.TagId, MiscFeeTypeField.TagId)
