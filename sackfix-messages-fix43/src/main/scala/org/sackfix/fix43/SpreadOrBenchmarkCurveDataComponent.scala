...
case class SpreadOrBenchmarkCurveDataComponent(spreadField:Option[SpreadField]=None,
                                               ...
                                               benchmarkCurvePointField:Option[BenchmarkCurvePointField]=None) extends SfFixComponent  with SfFixRenderable with SfFixFieldsToAscii {
...
object SpreadOrBenchmarkCurveDataComponent extends SfFixDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    SpreadField.TagId, BenchmarkCurveCurrencyField.TagId, BenchmarkCurveNameField.TagId, BenchmarkCurvePointField.TagId)
