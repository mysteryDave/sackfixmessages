...
object AdvertisementMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    AdvRefIDField.TagId, PriceField.TagId, CurrencyField.TagId, TradeDateField.TagId, TransactTimeField.TagId, 
    TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId, URLLinkField.TagId, LastMktField.TagId, 
