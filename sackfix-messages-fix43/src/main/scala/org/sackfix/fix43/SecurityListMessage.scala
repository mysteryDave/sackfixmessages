...
case class SecurityListMessage(securityReqIDField:SecurityReqIDField,
                               ...
                               totalNumSecuritiesField:Option[TotalNumSecuritiesField]=None,
  ...
  def format( fmt: ((StringBuilder,SfFixRenderable)=>Unit), b:StringBuilder = new StringBuilder()): StringBuilder = {
    ...
    totalNumSecuritiesField.foreach(fmt(b,_))
...
object SecurityListMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    TotalNumSecuritiesField.TagId, NoRelatedSymField.TagId)
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(SecurityListMessage(SecurityReqIDField.decode(myFields.get(SecurityReqIDField.TagId)).get,
        ...
        myFields.get(TotalNumSecuritiesField.TagId).flatMap(f=>TotalNumSecuritiesField.decode(f)),
