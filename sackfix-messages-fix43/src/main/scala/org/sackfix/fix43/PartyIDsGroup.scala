...
case class PartyIDsGroup(partyIDField:Option[PartyIDField]=None,
                         ...
                         partySubIDField:Option[PartySubIDField]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
...
object PartyIDsGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    PartyIDField.TagId, PartyIDSourceField.TagId, PartyRoleField.TagId, PartySubIDField.TagId)
    ...
    if (!isFirstField(flds(startPos)._1)) (startPos, None)
      ...
      if (myFields.nonEmpty) {
        (pos,Some(PartyIDsGroup(myFields.get(PartyIDField.TagId).flatMap(f=>PartyIDField.decode(f)),
          ...
          myFields.get(PartySubIDField.TagId).flatMap(f=>PartySubIDField.decode(f)))))
      } else (startPos, None)
    }
  }
