...
object OrderCancelRejectMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    ListIDField.TagId, AccountField.TagId, AccountTypeField.TagId, TradeOriginationDateField.TagId, TransactTimeField.TagId, 
    CxlRejReasonField.TagId, TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId)
