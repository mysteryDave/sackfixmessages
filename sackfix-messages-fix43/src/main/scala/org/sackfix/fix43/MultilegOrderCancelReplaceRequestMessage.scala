...
case class MultilegOrderCancelReplaceRequestMessage(orderIDField:Option[OrderIDField]=None,
                                                    ...
                                                    netMoneyField:Option[NetMoneyField]=None) extends SfFixMessageBody("AC")  with SfFixRenderable with SfFixFieldsToAscii {
...
object MultilegOrderCancelReplaceRequestMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    OrderIDField.TagId, SecondaryClOrdIDField.TagId, ClOrdLinkIDField.TagId, OrigOrdModTimeField.TagId, AccountField.TagId, 
    AccountTypeField.TagId, DayBookingInstField.TagId, BookingUnitField.TagId, PreallocMethodField.TagId, NoAllocsField.TagId, 
    SettlmntTypField.TagId, FutSettDateField.TagId, CashMarginField.TagId, ClearingFeeIndicatorField.TagId, ExecInstField.TagId, 
    MinQtyField.TagId, MaxFloorField.TagId, ExDestinationField.TagId, NoTradingSessionsField.TagId, ProcessCodeField.TagId, 
    PrevClosePxField.TagId, NoLegsField.TagId, LocateReqdField.TagId, QuantityTypeField.TagId, PriceTypeField.TagId, 
    ...
    PositionEffectField.TagId, CoveredOrUncoveredField.TagId, MaxShowField.TagId, PegDifferenceField.TagId, DiscretionInstField.TagId, 
    ...
    MultiLegRptTypeReqField.TagId, NetMoneyField.TagId)
