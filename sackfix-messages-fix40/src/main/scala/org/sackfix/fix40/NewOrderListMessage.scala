...
case class NewOrderListMessage(listIDField:ListIDField,
                               ...
                               textField:Option[TextField]=None) extends SfFixMessageBody("E")  with SfFixRenderable with SfFixFieldsToAscii {
...
object NewOrderListMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    IssuerField.TagId, SecurityDescField.TagId, PrevClosePxField.TagId, LocateReqdStringField.TagId, PriceField.TagId, 
    StopPxField.TagId, CurrencyField.TagId, TimeInForceField.TagId, ExpireTimeField.TagId, CommissionField.TagId, 
