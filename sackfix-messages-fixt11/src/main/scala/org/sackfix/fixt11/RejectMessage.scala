...
object RejectMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    RefTagIDField.TagId, RefMsgTypeField.TagId, RefApplVerIDField.TagId, RefApplExtIDField.TagId, RefCstmApplVerIDField.TagId, 
    SessionRejectReasonField.TagId, TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId)
