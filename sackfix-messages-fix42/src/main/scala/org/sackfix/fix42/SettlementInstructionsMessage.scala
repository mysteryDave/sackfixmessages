...
object SettlementInstructionsMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    SettlLocationField.TagId, TradeDateField.TagId, AllocIDField.TagId, LastMktField.TagId, TradingSessionIDField.TagId, 
    SideField.TagId, SecurityTypeField.TagId, EffectiveTimeField.TagId, ClientIDField.TagId, ExecBrokerField.TagId, 
    ...
    CashSettlAgentAcctNumField.TagId, CashSettlAgentAcctNameField.TagId, CashSettlAgentContactNameField.TagId, CashSettlAgentContactPhoneField.TagId)
