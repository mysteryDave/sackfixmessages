...
/**
  ...
  */
case class QuoteStatusRequestMessage(quoteIDField:Option[QuoteIDField]=None,
                                     ...
                                     tradingSessionIDField:Option[TradingSessionIDField]=None) extends SfFixMessageBody("a")  with SfFixRenderable with SfFixFieldsToAscii {
...
object QuoteStatusRequestMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    QuoteIDField.TagId, SymbolSfxField.TagId, SecurityIDField.TagId, IDSourceField.TagId, SecurityTypeField.TagId, 
    ...
    EncodedIssuerField.TagId, SecurityDescField.TagId, EncodedSecurityDescLenField.TagId, EncodedSecurityDescField.TagId, SideField.TagId, 
    TradingSessionIDField.TagId)
  ...
  override def isFirstField(tagId:Int) : Boolean = tagId==QuoteIDField.TagId 
  ...
  override def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SfFixMessageBody] = {
    ...
    if (MandatoryFields.isEmpty || myFields.nonEmpty) {
      Some(QuoteStatusRequestMessage(myFields.get(QuoteIDField.TagId).flatMap(f=>QuoteIDField.decode(f)),
