...
case class MsgTypesGroup(refMsgTypeField:Option[RefMsgTypeField]=None,
                         msgDirectionField:Option[MsgDirectionField]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
...
object MsgTypesGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    RefMsgTypeField.TagId, MsgDirectionField.TagId)
