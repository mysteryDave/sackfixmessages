...
case class OrderCancelReplaceRequestMessage(orderIDField:Option[OrderIDField]=None,
                                            ...
                                            clearingAccountField:Option[ClearingAccountField]=None) extends SfFixMessageBody("G")  with SfFixRenderable with SfFixFieldsToAscii {
...
object OrderCancelReplaceRequestMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    NoAllocsField.TagId, SettlmntTypField.TagId, FutSettDateField.TagId, ExecInstField.TagId, MinQtyField.TagId, 
    MaxFloorField.TagId, ExDestinationField.TagId, NoTradingSessionsField.TagId, SymbolSfxField.TagId, SecurityIDField.TagId, 
    ...
    EncodedSecurityDescField.TagId, OrderQtyField.TagId, CashOrderQtyField.TagId, PriceField.TagId, StopPxField.TagId, 
    ...
    LocateReqdField.TagId, ClearingFirmField.TagId, ClearingAccountField.TagId)
