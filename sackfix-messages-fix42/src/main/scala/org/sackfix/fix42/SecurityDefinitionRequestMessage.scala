...
case class SecurityDefinitionRequestMessage(securityReqIDField:SecurityReqIDField,
                                            ...
                                            relatedSymGroups: Option[List[RelatedSymGroup]]=None) extends SfFixMessageBody("c")  with SfFixRenderable with SfFixFieldsToAscii {
...
object SecurityDefinitionRequestMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    SymbolField.TagId, SymbolSfxField.TagId, SecurityIDField.TagId, IDSourceField.TagId, SecurityTypeField.TagId, 
    ...
    TextField.TagId, EncodedTextLenField.TagId, EncodedTextField.TagId, TradingSessionIDField.TagId, NoRelatedSymField.TagId)
