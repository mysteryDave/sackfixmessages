...
case class AdvertisementMessage(advIdField:AdvIdField,
                                ...
                                tradingSessionIDField:Option[TradingSessionIDField]=None) extends SfFixMessageBody("7")  with SfFixRenderable with SfFixFieldsToAscii {
...
object AdvertisementMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    EncodedTextField.TagId, URLLinkField.TagId, LastMktField.TagId, TradingSessionIDField.TagId)
