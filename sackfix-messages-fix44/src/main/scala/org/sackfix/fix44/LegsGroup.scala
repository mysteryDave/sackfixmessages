...
/**
  ...
  */
case class LegsGroup(instrumentLegComponent:Option[InstrumentLegComponent]=None) extends SfFixGroup  with SfFixRenderable with SfFixFieldsToAscii {
...
object LegsGroup extends SfGroupDecoder {
  ...
  override def isMandatoryField(tagId:Int) : Boolean = {
    ...
    InstrumentLegComponent.isMandatoryField(tagId)
  }
  ...
  override def isOptionalField(tagId:Int) : Boolean = {
    ...
    InstrumentLegComponent.isOptionalField(tagId)
  }

  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    InstrumentLegComponent.isFieldOf(tagId)
