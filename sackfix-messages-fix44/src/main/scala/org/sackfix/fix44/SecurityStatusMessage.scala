...
object SecurityStatusMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    SecurityStatusReqIDField.TagId, NoUnderlyingsField.TagId, NoLegsField.TagId, CurrencyField.TagId, TradingSessionIDField.TagId, 
    TradingSessionSubIDField.TagId, UnsolicitedIndicatorField.TagId, SecurityTradingStatusField.TagId, FinancialStatusField.TagId, CorporateActionField.TagId, 
