...
object CollateralInquiryMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    CollInquiryIDField.TagId, SubscriptionRequestTypeField.TagId, ResponseTransportTypeField.TagId, ResponseDestinationField.TagId, AccountField.TagId, 
    AccountTypeField.TagId, ClOrdIDField.TagId, OrderIDField.TagId, SecondaryOrderIDField.TagId, SecondaryClOrdIDField.TagId, 
    SettlDateField.TagId, QuantityField.TagId, QtyTypeField.TagId, CurrencyField.TagId, MarginExcessField.TagId, 
  ...
  override def isFieldOf(tagId:Int) : Boolean = isMandatoryField(tagId) || isOptionalField(tagId)  || 
    ...
    InstrmtLegGrpComponent.isFieldOf(tagId) || UndInstrmtGrpComponent.isFieldOf(tagId) || TrdRegTimestampsComponent.isFieldOf(tagId) || 
