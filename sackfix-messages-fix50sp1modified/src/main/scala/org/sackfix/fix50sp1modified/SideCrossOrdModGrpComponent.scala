...
/**
  ...
  */
case class SideCrossOrdModGrpComponent(noSidesField:NoSidesField,
...
object SideCrossOrdModGrpComponent extends SfFixDecoder {
  ...
  def decode(flds: Seq[Tuple2[Int, Any]], startPos:Int = 0):Option[SideCrossOrdModGrpComponent] = {
    val (pos, myFields, nextTagPosLookup) = extractMyFieldsAndPopulatePositions(false, flds, startPos)
    validateMandatoryFieldsPresent(myFields)

    if (myFields.nonEmpty) {
      Some(SideCrossOrdModGrpComponent(NoSidesField.decode(myFields.get(NoSidesField.TagId)).get,
