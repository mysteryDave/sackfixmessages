...
object QuoteCancelMessage extends SfFixMessageDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    QuoteReqIDField.TagId, QuoteIDField.TagId, QuoteMsgIDField.TagId, QuoteResponseLevelField.TagId, AccountField.TagId, 
    AcctIDSourceField.TagId, AccountTypeField.TagId, TradingSessionIDField.TagId, TradingSessionSubIDField.TagId)
