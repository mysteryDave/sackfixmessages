...
object InstrumentLegComponent extends SfFixDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    ...
    LegOptAttributeField.TagId, LegContractMultiplierField.TagId, LegUnitOfMeasureField.TagId, LegUnitOfMeasureQtyField.TagId, LegPriceUnitOfMeasureField.TagId, 
    LegPriceUnitOfMeasureQtyField.TagId, LegTimeUnitField.TagId, LegExerciseStyleField.TagId, LegCouponRateField.TagId, LegSecurityExchangeField.TagId, 
    LegIssuerField.TagId, EncodedLegIssuerLenField.TagId, EncodedLegIssuerField.TagId, LegSecurityDescField.TagId, EncodedLegSecurityDescLenField.TagId, 
    EncodedLegSecurityDescField.TagId, LegRatioQtyField.TagId, LegSideField.TagId, LegCurrencyField.TagId, LegPoolField.TagId, 
    LegDatedDateField.TagId, LegContractSettlMonthField.TagId, LegInterestAccrualDateField.TagId, LegPutOrCallField.TagId, LegOptionRatioField.TagId, 
    LegPriceField.TagId)
